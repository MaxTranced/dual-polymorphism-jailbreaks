...
* [**`dual_polymorphism_blog.html`**](./dual_polymorphism_blog.html): The full, formatted essay detailing the causal model, the synthesis of existing literature (GCG, Anthropic's superposition work, Bailey et al. 2024), and an enumeration of the strongest counterarguments. 
